                ...
                <div class="row d-flex flex-wrap">
                    ...
                    <div class="form1" hidden>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control"  value="<?php echo $item["hinh_anh"] ?>">
                            <div class="form-message text-danger mt-2"></div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="price" id="price" class="form-control" required value="<?php echo $item["gia"] ?>">
                            <div class="form-message text-danger mt-2"></div>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <select name="id_loai_hang" id="id_cate" class="form-control">
                                <?php foreach ($loai_hang as $values) { ?>
                                    <option value="<?php echo $values['id_loai_hang'] ?>">  <?php echo $values['ten_loai_hang'] ?> </option>
                                <?php } ?>
                            </select>
                            <div class="form-message text-danger mt-2"></div>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="so_luong" id="so_luong" class="form-control" required value="<?php echo $item["so_luong"] ?>">
                            <div class="form-message text-danger mt-2"></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <label for="" class="form-label">Mô tả</label>
                        <textarea name="mo_ta" required id="mo_ta" class="form-control" cols="30" rows="10"><?php echo $item["mo_ta"] ?></textarea>
                        <div class="form-message text-danger mt-2"></div>
                    </div>
                </div>
                <div class="mt-5 mb-5">
