                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover table-fw-widget" id="table1">
                            ...
                            <tbody>
                            <?php foreach ($hoa_don as  $value) : ?>
                                <tr class="odd gradeX">
                                    <td><?php echo $value["ten_khachhang"]?></td>
                                    <td>
                                    ...
                                    <td><?php echo $value["so_dt"]?></td>
                                    <td class="center"><?php echo $value["tong_tien"]?></td>
                                    <td><?php echo $value["trang_thai"] ?></td>
                                    <td class="center">
                                            <a href="chi_tiet.php?id=<?php echo $value["id"] ?>"><button>Chi tiết</button></a>
                                    <td class="center">
                                            <a href="update_hoadon.php?id=<?php echo $value["id"] ?>"><button class="update">Update</button></a>
                                            <a onclick="return confirm('Bạn có chắc muốn xóa ??')" href="./controller/hoa_don/delete.php?id=<?php echo $value["id"] ?>"><button class="delete">Delete</button></a>
                                        </td>
                                </tr>
                            <?php endforeach ?>
