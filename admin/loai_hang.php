                            ...
                            <tbody>
                                <?php foreach ($loai_hang as $value) : ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="update_cate.php?id=<?php echo $value["id_loai_hang"] ?>"><button class="update">Update</button></a>
                                            <a onclick="return confirm('Bạn có chắc muốn xóa ??')" href="./controller/cate/delete_cate.php?id=<?php echo $value["id_loai_hang"] ?>"><button class="delete">Delete</button></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
