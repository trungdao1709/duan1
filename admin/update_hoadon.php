...
<div class="be-content">
    ...
    <div class="main-content container-fluid">
        <div>
            <form method="post" id="form_1" action="./controller/hoa_don/update.php">
            <input type="text" name='id' hidden value="<?php echo $hoa_don['id'] ?>">
                <div class="d-flex justify-content-center">
                    <div class="col-6">
                        <div class="form-group mb-3">
                            <label for="name_cate" class="form-label">Trạng thái</label>
